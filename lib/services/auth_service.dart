...
class AuthService {
  ...
  Future<Map<String, dynamic>> addRelative(
    ...
    try {
      ...
      print('Adding relative with data: name=$name, surname=$surname, email=$email, phone=$phone');
      ...
      print('Add relative response status: ${response.statusCode}');
      print('Add relative response body: ${response.body}');
